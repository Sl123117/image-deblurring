...
Checkpoint resume is model-specific: a `unet` checkpoint can only resume into `--model-name unet`, and a motion-routed checkpoint can only resume into `--model-name motion_routed_unet`.
